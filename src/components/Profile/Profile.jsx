...
function Profile (props) {
  ...
  function validate() {
    if (emailInput && nameInput && !(emailInput.validationMessage || nameInput.validationMessage)) 
    return (submitButton.classList.remove('profile__link-disabled'), submitButton.classList.add('profile__link'), submitButton.disabled = false); 
    else if (emailInput && nameInput) return (submitButton.classList.remove('profile__link'), submitButton.classList.add('profile__link-disabled'), submitButton.disabled = true)
  }
      ...
      <section className="profile">
        <form onSubmit={handleSubmit} id="profile__form" className="profile__container">
          ...
          <div className="profile__link-container">
            ...
            className=/*{(isNameValid && isEmailValid && (!(userName === currentUser.name) && (email === currentUser.email))) ? "profile__underbottom-text profile__link" : "profile__underbottom-text profile__link-disabled"}*/"profile__underbottom-text profile__link" disabled
